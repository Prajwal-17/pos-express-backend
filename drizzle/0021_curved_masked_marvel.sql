...
INSERT INTO `__new_product_history`("id", "name", "weight", "unit", "product_id", "old_price", "new_price", "old_mrp", "new_mrp", "old_purchase_price", "new_purchase_price", "created_at", "updated_at") SELECT "id", "name", "weight", "unit", "product_id", "old_price", "new_price", "old_mrp", "new_mrp", "old_purchase_price", "new_purchase_price", "created_at", "updated_at" FROM `product_history`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_estimate_items`("id", "estimate_id", "product_id", "name", "mrp", "price", "purchase_price", "weight", "unit", "quantity", "total_price", "created_at", "updated_at") SELECT "id", "estimate_id", "product_id", "name", "mrp", "price", "purchase_price", "weight", "unit", "quantity", "total_price", "created_at", "updated_at" FROM `estimate_items`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_products`("id", "name", "weight", "unit", "mrp", "price", "purchase_price", "total_quantity_sold", "is_disabled", "disabled_at", "is_deleted", "deleted_at", "created_at", "updated_at") SELECT "id", "name", "weight", "unit", "mrp", "price", "purchase_price", "total_quantity_sold", "is_disabled", "disabled_at", "is_deleted", "deleted_at", "created_at", "updated_at" FROM `products`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_sale_items`("id", "sale_id", "product_id", "name", "mrp", "price", "purchase_price", "weight", "unit", "quantity", "total_price", "created_at", "updated_at") SELECT "id", "sale_id", "product_id", "name", "mrp", "price", "purchase_price", "weight", "unit", "quantity", "total_price", "created_at", "updated_at" FROM `sale_items`;--> statement-breakpoint
